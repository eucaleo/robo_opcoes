...
class UIDataModel:
    ...
    # ------------------------------------------------------------------
    # Compatibilidade: _cache_abas continua funcionando (alias)
    # ------------------------------------------------------------------
    @property
    def _cache_abas(self) -> List[str]:
        return self._cache_structures

    @_cache_abas.setter
    def _cache_abas(self, value: List[str]):
        self._cache_structures = value
    ...
    def get_structure_ids(self) -> List[str]:
        """patch_34: metodo canonico. Substitui get_abas() e get_structures()."""
        if not self._cache_structures:
            self._cache_structures = self._load_structures()
        return list(self._cache_structures)

    def get_abas(self) -> List[str]:
        """Deprecated (patch_34). Use get_structure_ids()."""
