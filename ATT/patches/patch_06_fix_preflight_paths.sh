...
echo "=== PATCH 06: Corrigindo paths no preflight_check_v2.py ==="

# Backup do arquivo original
if [[ ! -f scripts/preflight_check_v2.py.bak ]]; then
    cp scripts/preflight_check_v2.py scripts/preflight_check_v2.py.bak
    echo "✓ Backup criado: scripts/preflight_check_v2.py.bak"
fi

# Aplicar correções no preflight
cat > scripts/preflight_check_v2.py <<'EOF'
#!/usr/bin/env python3
"""
...
class PreflightChecker:
    ...
    def _find_db(self, db_name):
        ...
        candidates = [
            self.repo_root / "data" / db_name,  # Padrão atual
    ...
    def check_database(self, db_name, required=True):
        ...
        try:
            ...
            is_standard = db_path == self.repo_root / "data" / db_name
    ...
    def check_directories(self):
        ...
        required_dirs = ["data", "scripts", "bridge"]
    ...
    def run_all_checks(self):
        ...
        print("🚀 Preflight Check v2 - Verificando ambiente...")
        ...
        # Status final
        if failed > 0:
            print("\n❌ PREFLIGHT FALHOU - Corrija os erros antes de continuar")
            return 1
        elif not app_ok or not derived_ok:
            print("\n❌ BANCOS CRÍTICOS INDISPONÍVEIS")
            return 1
        elif warned > 0:
            print("\n⚠️  PREFLIGHT OK COM AVISOS")
            return 0
        else:
            print("\n✅ PREFLIGHT OK - Ambiente pronto!")
            return 0
...
echo "✓ scripts/preflight_check_v2.py atualizado com paths corretos"
echo ""
echo "=== TESTE DO PATCH ==="
python scripts/preflight_check_v2.py

echo ""
echo "🎯 PATCH 06 CONCLUÍDO!"
echo "   - Preflight agora procura bancos em dados/ primeiro"
echo "   - Fallback para raiz em casos legados"
echo "   - Relatórios salvos em ATT/reports/"
