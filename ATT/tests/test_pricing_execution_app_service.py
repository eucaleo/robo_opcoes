...
def test_execute_pricing_returns_persisted_record_when_present():
    orchestration_service = FakePricingExecutionOrchestrationService(
        response={
            "persisted": {
                "record": {
                    "id": 123,
    ...
    service = PricingExecutionAppService(
        ...
        pricing_execution_query_service=query_service,
    )
    ...
    assert orchestration_service.calls == [
        {
            "structure_id": 10,
            "reference_date": "2026-05-16",
        }
...
def test_execute_pricing_rejects_invalid_structure_id():
    orchestration_service = FakePricingExecutionOrchestrationService(response={})
    query_service = FakePricingExecutionQueryService()
