...
| `UI\components\decisions_grid.py` | [PARCIAL] MISTO | 4 | 13 | 0 |
| `UI\components\details_panel.py` | [PARCIAL] MISTO | 21 | 33 | 10 |
| `UI\components\filters_panel.py` | [PARCIAL] MISTO | 2 | 2 | 0 |
| `UI\components\payoff_chart.py` | [PARCIAL] MISTO | 2 | 2 | 0 |
| `UI\components\structure_editor_dialog.py` | [PARCIAL] MISTO | 2 | 14 | 0 |
| `UI\components\structures_list_panel.py` | [PARCIAL] MISTO | 4 | 6 | 0 |
| `UI\debug_utils.py` |  NEUTRO | 0 | 0 | 0 |
| `UI\main_window.py` | [PARCIAL] MISTO | 10 | 16 | 3 |
| `UI\models\__init__.py` |  NEUTRO | 0 | 0 | 0 |
| `UI\models\ui_data.py` | [PARCIAL] MISTO | 40 | 49 | 9 |
...
- [ERRO] LEGADO_PURO : 0 arquivo(s)
- [PARCIAL] MISTO       : 8 arquivo(s)
- [OK] CANÔNICO    : 0 arquivo(s)
-  NEUTRO      : 4 arquivo(s)
