...
- o teste contratual 5G passou a fechar explicitamente conexoes SQLite;
- motivo: em Windows, o contexto sqlite3.connect(...) realiza commit/rollback, mas nao garante fechamento fisico imediato da conexao;
- a correcao evita lock do arquivo temporario dados/app.db durante limpeza de TemporaryDirectory.
...
- FRENTE_BD_UNICO_APPDB/evidencias/149_phase5g_inventario_absorcao_funcional.txt
- FRENTE_BD_UNICO_APPDB/evidencias/150_phase5g_contrato_absorcao_funcional.txt
- FRENTE_BD_UNICO_APPDB/evidencias/151_phase5g_contrato_absorcao_funcional_corrigido.txt
