...
def format_report_aba(entries) -> str:
    """Formata relatorio de auditoria de surface ABA em texto legivel.

    Cada entry deve expor structure_id, reference_date e aba_str.
    """
    lines: list = []
    for e in entries:
        structure_id   = getattr(e, "structure_id",   getattr(e, "file", "?"))
        reference_date = getattr(e, "reference_date", getattr(e, "line", "?"))
