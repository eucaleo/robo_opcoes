...
echo "== Documentacao automatizada das pendencias remanescentes da UI =="
...
echo "$AUDIT_DOC"
echo "$DEV_DOC"
echo "scripts/documentar_pendencias_ui.sh"
...
git add scripts/documentar_pendencias_ui.sh
...
echo
echo "== Trecho final da auditoria =="
tail -n 60 "$AUDIT_DOC"

echo
echo "== Trecho final do documento de desenvolvimento =="
tail -n 60 "$DEV_DOC"
...
if git diff --cached --quiet; then
  ...
  echo
  echo "== Criando commit documental automatizado =="
...
echo
echo "== Fim. Nenhum push foi executado. =="
